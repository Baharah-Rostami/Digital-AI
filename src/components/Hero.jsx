...
export default function Hero() {
  return (
    <section id="hero" className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 
    text-center w-full overflow-hidden text-gray-700 dark:text-white dark:bg-black">

        <div className="inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full">
            <img src={images.profileImages} alt="" className="w-20"/>
        ...
        max-w-5xl">
          ...
          <p className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75
           max-w-4/5 sm:max-w-lg pb-4">Creating smarter digital experiences for everyone</p>
