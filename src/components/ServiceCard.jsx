...
export default function ServiceCard({service, index }) {
  ...
  return (
    ...
    shadow-2xl shadow-gray-100 dark:shadow-white/10">
        ...
        <div className="pointer-events-none blur-2xl rounded-full bg-linear-to-r from-blue-500 via-indigo-500 
        to-purple-500 w-75 h-75 absolute z-0 transition-opacity duration-500 mix-blend-lighten opacity-70"
